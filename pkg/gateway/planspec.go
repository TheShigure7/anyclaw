...
func (p *PlanSpec) AddWorkflowStep(workflow *plugin.AppWorkflowMatch, inputs map[string]any) {
	step := PlanStep{
		Title:            workflow.Workflow.Name,
		Description:      workflow.Workflow.Description,
		Kind:             "workflow",
		Plugin:           workflow.Workflow.Plugin,
	...
	if workflow.Pairing != nil {
		step.Description = fmt.Sprintf("%s (paired: %s)", step.Description, workflow.Pairing.Name)
	}
...
// AddWorkflowStep 添加工作流步骤
func (b *PlanBuilder) AddWorkflowStep(workflow *plugin.AppWorkflowMatch, inputs map[string]any) *PlanBuilder {
