...
func (p PersistentSubagentProfile) IsEnabled() bool {
	return p.Enabled == nil || *p.Enabled
}

func (p PersistentSubagentProfile) IsManagedByMain() bool {
	return p.ManagedByMain == nil || *p.ManagedByMain
}

func (s MarketSourceRef) IsEnabled() bool {
