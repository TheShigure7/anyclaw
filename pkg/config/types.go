...
type Config struct {
	...
	PersistentSubagents PersistentSubagentsConfig `json:"persistent_subagents,omitempty"`
...
type DelegationConfig struct {
	PersistentSubagentFirst             bool `json:"persistent_subagent_first"`
	AllowTemporarySubagents            bool `json:"allow_temporary_subagents"`
	MaxDepth                           int  `json:"max_depth"`
	PersistentSubagentSessionTTLMinutes int  `json:"persistent_subagent_session_ttl_minutes,omitempty"`
	TemporarySubagentTTLMinutes        int  `json:"temporary_subagent_ttl_minutes,omitempty"`
}

type PersistentSubagentsConfig struct {
	Enabled  bool                       `json:"enabled"`
	Visible  bool                       `json:"visible"`
	Profiles []PersistentSubagentProfile `json:"profiles,omitempty"`
}

type PersistentSubagentProfile struct {
	ID                string          `json:"id"`
	DisplayName       string          `json:"display_name"`
	Description       string          `json:"description,omitempty"`
	AvatarPreset      string          `json:"avatar_preset,omitempty"`
	AvatarDataURL     string          `json:"avatar_data_url,omitempty"`
	ManagedByMain     *bool           `json:"managed_by_main,omitempty"`
...
type MarketConfig struct {
	Enabled bool               `json:"enabled"`
	Sources []MarketSourceRef  `json:"sources,omitempty"`
}
